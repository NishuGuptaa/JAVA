...
import java.util.*;
public class q27Whichangledtriangle {
    public static void main(String[] args) {
        ...
        int twiceMaxSquare = 2 * maxSide * maxSide;

        if(twiceMaxSquare < sumSquares){
            System.out.print(1); // Acute
        } 
        else if(twiceMaxSquare == sumSquares){
            System.out.print(2); // Right
        } 
        else{
            System.out.print(3); // Obtuse
        }
    }
